...
- affiliation: University of Tübingen          # When knitting to PDF
  ...
  url: https://uni-tuebingen.de/de/175743      # - "Jürgen Schneider, juergen.schneider@uni-tuebingen.de"
- affiliation: University of Tübingen          # - "Iris Backfisch, iris.backfisch@uni-tuebingen.de"
  email: iris.backfisch@uni-tuebingen          # under the 'author:'.
  name: Iris Backfisch                         # PDF does not support author affiliations
  url: https://uni-tuebingen.de/de/169665      # and will display 'true' instead of names
date: "`r Sys.Date()`"
output:
  html_document:
    code_folding: hide
...
|:---------|:---------------------|:----------------------------|
| MARS |  Left out paper section "Abstract"  |  An abstract is important for reporting, however not, for planning and registering. |
| MARS |  Left out paper section "Results" and parts of "Discussion"  |  Specifications on how to report results is important for reporting, however not, for planning and registering. Prospective information on how results will be computed/ synthesized is preserved. |
